...
public class TouchscreenHovering {
    ...
    private static final String COMMAND_STATUS_PATH = "/sys/class/sec/tsp/cmd_status";
    private static final String HOVER_MODE = "boost_level";
    private static final String HOVER_MODE_ENABLE = "boost_level,2";
    private static final String HOVER_MODE_DISABLE = "boost_level,0";
    ...
    public static boolean isEnabled() {
        return (HOVER_MODE_ENABLE + ":" + STATUS_OK).equals(
                FileUtils.readOneLine(COMMAND_RESULT_PATH) + FileUtils.readOneLine(COMMAND_STATUS_PATH));
    }
