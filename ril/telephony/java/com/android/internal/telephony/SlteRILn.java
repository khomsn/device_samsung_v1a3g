 ...
 * {@hide}
 */
public class SlteRILn extends RIL {
    ...
    public SlteRILn(Context context, int preferredNetworkType, int cdmaSubscription) {
        super(context, preferredNetworkType, cdmaSubscription, null);
    }

    public SlteRILn(Context context, int preferredNetworkType,
    ...
    processUnsolicited(Parcel p, int type) {
        ...
        if (newResponse != origResponse) {
            riljLog("SlteRILn: remap unsolicited response from " +
