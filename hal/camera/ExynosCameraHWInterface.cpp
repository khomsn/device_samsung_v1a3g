...
static camera_device_ops_t camera_device_ops = {
        .set_preview_window = HAL_camera_device_set_preview_window,
        .set_callbacks = HAL_camera_device_set_callbacks,
        .enable_msg_type = HAL_camera_device_enable_msg_type,
        .disable_msg_type = HAL_camera_device_disable_msg_type,
        .msg_type_enabled = HAL_camera_device_msg_type_enabled,
        .start_preview = HAL_camera_device_start_preview,
        .stop_preview = HAL_camera_device_stop_preview,
        .preview_enabled = HAL_camera_device_preview_enabled,
        .store_meta_data_in_buffers = HAL_camera_device_store_meta_data_in_buffers,
        .start_recording = HAL_camera_device_start_recording,
        .stop_recording = HAL_camera_device_stop_recording,
        .recording_enabled = HAL_camera_device_recording_enabled,
        .release_recording_frame = HAL_camera_device_release_recording_frame,
        .auto_focus = HAL_camera_device_auto_focus,
        .cancel_auto_focus = HAL_camera_device_cancel_auto_focus,
        .take_picture = HAL_camera_device_take_picture,
        .cancel_picture = HAL_camera_device_cancel_picture,
        .set_parameters = HAL_camera_device_set_parameters,
        .get_parameters = HAL_camera_device_get_parameters,
        .put_parameters = HAL_camera_device_put_parameters,
        .send_command = HAL_camera_device_send_command,
        .release = HAL_camera_device_release,
        .dump = HAL_camera_device_dump,
};
